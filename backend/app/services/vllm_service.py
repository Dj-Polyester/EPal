...
async def chat_completion(messages: list[dict], max_tokens: int = 512, temperature: float = 0.8) -> str:
...
async def summarize_text(text: str, max_tokens: int = 256) -> str:
    ...
    messages = [
        {"role": "system", "content": "Summarize the following conversation history concisely, preserving key facts, events, and relationship dynamics."},
